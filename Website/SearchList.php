...
<head>
  ...
  <title><?php echo $_SESSION["songname"]?></title>
...
<body>
  ...
  <div class="container1">
    ...
    <ol class="list-group">
      <?php
      $search_query = htmlspecialchars($_SESSION["songname"]);
      $sql = "SELECT * FROM allsongs WHERE track_name LIKE '%$search_query%'";
      $result = mysqli_query($con, $sql);
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        <li class="list-group-item d-flex justify-content-center bg-dark bg-opacity-25">
            <div class="Ctitle fw-bold text-black"><?php echo mysqli_num_rows($result)?> Songs Found</div>
        </li>
        <?php
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <li class="list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 mt-1 mb-1 me-auto">
              <div class="fw-bold"><a href="SearchSongPage.php?track_name=<?php echo urlencode($row["track_name"]); ?>"
        ...
        ?>
        <li class="list-group-item d-flex justify-content-center bg-dark bg-opacity-25">
            <div class="Ctitle fw-bold text-black">0 Songs Found</div>
        </li>
        <?php
      }
