  ...
  <div class="container1">
    ...
    <ol class="list-group">
      <li class="list-group-item d-flex justify-content-center bg-dark bg-opacity-25">
        <div class="Ctitle fw-bold text-black">Latest EP's</div>
      </li>
      <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <li class="list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 mt-1 mb-1 me-auto">
              <div class="fw-bold"><a href="EpPage.php?ep_name=<?php echo urlencode($row["ep_name"]); ?>"
                  class="text-black text-decoration-none"><?php echo $row["ep_name"] . " - " . $row["artist"] . " (" . $row["version"] . ")" ?></a></div>
            </div>
          </li>
          <?php
        }
