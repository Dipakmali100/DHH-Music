...
if (isset($_POST['asubmit'])) {
  ...
  $sql1 = "INSERT INTO songs (track_name, type, version, track_link_id, poster_link_id, artist1, artist2, artist3) VALUES ('$track_name', 'MIXED', '$version', '$track_link_id', '$poster_link_id','$artist1', '$artist2', '$artist3')";
...
<body>
  ...
  <div class="heading text-center mt-3">
    <h1 class="fw-bold">Upload Song</h1>
  ...
  <div class="container3 bg-dark">
    <form method="post">
      <div class="Row">
        <input type="text" name="track_name" placeholder="Song Name" style="text-transform: uppercase;" class="input"
          required>
      </div>
      <div class="Row">
      ...
      <div class="Row">
        <input type="text" name="artist1" placeholder="First Artist" style="text-transform: uppercase;" class="input"
          required>
      </div>
      <div class="Row">
