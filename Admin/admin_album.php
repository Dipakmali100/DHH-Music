...
if (isset($_POST['asubmit'])) {
  ...
  $sql1 = "INSERT INTO albums (album_name, artist, version, poster_link, track_no) VALUES ('$album_name', '$artist', '$version', '$poster_link_id','$track_no')";
  $album_name = strtolower($_POST['album_name']);
...
<header>
  ...
  <div class="heading text-center mt-3">
    <h1 class="fw-bold">Upload Album</h1>
  ...
  <div class="container4 bg-dark">
    <form method="post">
      <div class="Row">
        <input type="text" name="album_name" placeholder="Album Name" style="text-transform: uppercase;" class="input"
          required>
      </div>
      <div class="Row">
